...
async def import_xml(file: UploadFile = File(...)):
    try:
        ...
        # Обрабатываем разные структуры XML для артефактов
        ...
        for artifact in artifacts:
            try:
                # Извлечение данных из XML с проверкой на наличие элементов
                ...
                # Проверка существования археолога
                ...
                # Проверка существования артефакта с таким же именем и археологом
...
def read_root(request: Request):
    ...
    try:
        # Получаем параметры для отображения сообщений об ошибках
